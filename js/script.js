...
window.onload=function(){
    ...
    document.querySelector('button.yp_books').addEventListener('click',function(e){
        e.preventDefault();
        location.href="http://www.eunjinjeong.kr/YPbooks/index.html";
    })
    document.querySelector('button.hana').addEventListener('click',function(e){
        e.preventDefault();
        location.href="http://www.eunjinjeong.kr/hana/index.html";
    })
};
